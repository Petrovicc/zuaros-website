...
// One geometry source supplies React, all logo exports, and raster derivatives.
const symbol = `<path d="${mark.body}" fill="currentColor"/><path d="${mark.spark}" fill="currentColor"/>`;
const wordmark =
...
const social = wrap(
  `<rect width="1200" height="630" fill="#101211"/><g transform="translate(65 50)"><g color="#edb466">${symbol}</g><g color="#f1f0e9" transform="translate(78 2) scale(1.27)">${wordmark}</g></g><g fill="none" stroke="#4a4940"><circle cx="948" cy="295" r="196"/><circle cx="948" cy="295" r="155" stroke-dasharray="2 7"/><ellipse cx="948" cy="295" rx="195" ry="95" transform="rotate(-40 948 295)"/><ellipse cx="948" cy="295" rx="195" ry="95" transform="rotate(40 948 295)"/></g><g color="#edb466" transform="translate(865 218) scale(2.8)">${symbol}</g><g font-family="Arial, sans-serif"><text x="65" y="244" font-size="65" letter-spacing="-3" fill="#f1f0e9">Custom software.</text><text x="65" y="320" font-size="65" letter-spacing="-3" fill="#edb466">Engineering tools.</text><text x="68" y="390" font-size="21" fill="#a4aaa1">Business. Engineering. Research.</text><text x="68" y="559" font-size="13" letter-spacing="3" fill="#a4aaa1">SOFTWARE DEVELOPMENT · ENGINEERING · DIGITAL PRODUCTS</text></g><path d="M65 510h1070" stroke="#34382f"/>`,
  "0 0 1200 630",
